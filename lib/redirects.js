...
const redirects = [
  ...
  { source: '/use-cases/ai-document-analyzer-for-law-firms', destination: '/industries/law-firm-ai-automation', permanent: true },
  ...
  { source: '/use-cases/client-onboarding-automation', destination: '/services/ai-intake-form-builder', permanent: true },
  ...
  // ---------------------------------------------------------------------
  { source: '/how-to/automate-youtube-shorts', destination: '/creators/ai-youtube-shorts-automation', permanent: true },
