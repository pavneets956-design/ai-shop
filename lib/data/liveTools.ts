...
export const systems: System[] = [
  ...
  { key: "proposal", name: "AI Admin System", problem: "Your business runs through scattered texts, emails, forms, and spreadsheets.", outcome: "One connected workflow for intake, follow-up, reminders, and reporting.", connects: "CRM · calendar · email · forms · payments", price: "From $3,500 CAD", time: "Live in 2–3 weeks", cta: "Plan my system", href: "/create" },
];
