...
export const servicesB: LandingContent[] = [
  {
    ...
    description: "Automated review requests sent at the right moment, personalized to each job. More 5-star reviews without chasing customers manually. From $1,000 CAD.",
    answer: "Most businesses get fewer reviews than they deserve because asking feels awkward and manual follow-up never happens. Handbuilt builds an AI review request system that fires a personalized message to each customer after their job closes — by SMS, email, or both — and routes happy customers straight to your Google Business Profile. Starts at $1,000 CAD.",
  ...
  },
  {
    ...
    description: "Smart intake forms that ask the right follow-up questions, qualify leads automatically, and route submissions to your inbox or CRM. From $1,000 CAD.",
    answer: "A standard contact form collects a name and email and stops there. Handbuilt builds AI-powered intake forms that adapt their questions based on what the visitor types — qualifying budget, scope, and timeline before you ever pick up the phone. Submissions route to your inbox, CRM, or calendar. Starts at $1,000 CAD.",
  ...
  },
  {
    ...
    description: "An AI assistant embedded in your site that guides visitors, answers questions, and collects leads — trained on your exact content. From $1,000 CAD.",
    answer: "Your website has the answers visitors need, but most people won't read five pages to find them. Handbuilt builds an AI website assistant trained on your pages, services, and FAQs that surfaces the right answer instantly and nudges visitors toward booking or calling. Live in about 5 days, starting at $1,000 CAD.",
  ...
  },
  {
    ...
    description: "An AI sales assistant that qualifies leads, sends follow-ups, and keeps warm prospects engaged — so no deal goes cold from neglect. From $2,500 CAD.",
  ...
  },
  {
    ...
    description: "An AI that handles scheduling, inbox triage, data entry, and routine admin tasks — so you stop drowning in low-value work. From $2,500 CAD.",
  ...
  },
  {
    ...
    description: "Generate contracts, service agreements, SOPs, and client docs in seconds from a form — consistent, on-brand, and ready to sign. From $1,000 CAD.",
    answer: "Writing the same contract or service agreement from scratch every time is slow and inconsistent. Handbuilt builds an AI document generator that takes a short form — client name, scope, price, dates — and outputs a formatted, brand-consistent document ready to send or sign. Starts at $1,000 CAD.",
  ...
  },
  {
    ...
    description: "Turn intake notes into a polished, branded proposal in minutes — not hours. Win more jobs with faster, more consistent quotes. From $1,000 CAD.",
    answer: "A slow proposal is a lost proposal. Handbuilt builds an AI proposal generator that takes the details from your intake form or discovery call notes and produces a branded, itemized proposal ready to send — in minutes instead of hours. Starts at $1,000 CAD.",
  ...
  },
  {
    ...
    description: "A phone agent that answers calls, qualifies leads, takes messages, and books appointments — 24/7, no hold music. From $2,500 CAD.",
  ...
  },
  {
    ...
    description: "Connect your tools and automate the manual steps between them — no more copy-paste between apps or chasing the same data in two places. From $2,500 CAD.",
  ...
  },
  {
    ...
    description: "A fully scoped AI automation system built around your exact operations — not a template. For businesses that have outgrown off-the-shelf tools. From $2,500 CAD.",
