          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {selfServeTools.map((t, i) => {
              ...
              return (
                <Reveal key={t.slug} delay={0.04 * i}>
                  ...
                  >
                    <span className="flex h-11 w-11 items-center justify-center rounded-xl border border-ink/[0.08] bg-paper-2/70 text-ink">
            ...
            <Reveal delay={0.04 * selfServeTools.length}>
              <div className="spec-frame flex h-full flex-col justify-center bg-paper-2/60 p-7">
                <span className="inline-flex w-fit items-center gap-2 rounded-full border border-line bg-white px-3 py-1 text-xs font-semibold text-ink">
                ...
                <Link
                  href="/shop"
                  className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-ink hover:text-ink"
                >
