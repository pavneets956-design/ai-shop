    ...
    <div className="min-h-screen bg-[#0a0a0a] py-12 pt-32">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12 flex justify-between items-center">
          <div>
            <h1 className="text-5xl font-light text-ink mb-2">Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="border border-ink/10 rounded-lg p-6">
          ...
          <div className="border border-ink/10 rounded-lg p-6">
            ...
            <div className="text-4xl font-light text-ink mb-2">{totalSales}</div>
            <div className="text-sm text-gray-500 flex items-center font-light">
              <TrendingUp className="w-3 h-3 mr-1" />
              +8% from last month
            </div>
        ...
        {/* Tabs */}
        <div className="mb-8 border-b border-ink/10">
        ...
        {activeTab === "overview" && (
          <div className="space-y-6">
            <div className="border border-ink/10 rounded-lg p-6">
              <h2 className="text-2xl font-light text-ink mb-6">Recent Activity</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-ink/5 rounded-lg border border-ink/5">
                  <div>
                    <p className="font-light text-ink">New sale: AI Receptionist Pro</p>
                    <p className="text-sm text-gray-500 font-light">2 hours ago</p>
                  </div>
                  <span className="text-ink font-light">+$99</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-ink/5 rounded-lg border border-ink/5">
                  <div>
                    <p className="font-light text-ink">New sale: Content Creator AI</p>
                    <p className="text-sm text-gray-500 font-light">5 hours ago</p>
                  </div>
                  <span className="text-ink font-light">+$149</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === "products" && (
          <div className="border border-ink/10 rounded-lg p-6">
            <h2 className="text-2xl font-light text-ink mb-6">My Products</h2>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {myProducts.map((product) => (
                    <tr key={product.id} className="border-b border-ink/5 hover:bg-ink/5 transition-colors">
                      <td className="py-4 px-4">
                        <Link
                          href={`/products/${product.id}`}
                          className="font-light text-ink hover:text-gray-300 transition-colors"
                        >
                          {product.title}
                        </Link>
                      </td>
        ...
        {activeTab === "analytics" && (
          <div className="border border-ink/10 rounded-lg p-6">
            <h2 className="text-2xl font-light text-ink mb-6">Analytics</h2>
