...
/*
 * NOTE FOR THIS HOTFIX BRANCH ONLY
 * --------------------------------
 * The transformation branch's copy of this file also covers /api/tools-demo,
 * /api/recommend and /api/tts — the unmetered OpenAI proxies. Those route
 * changes are deliberately NOT in this hotfix: they are a cost-abuse concern,
 * not the exposed-CRM concern this branch exists to close, and pulling them in
 * would widen a production hotfix to touch lib/rateLimit.ts as well.
 * They ship with feat/site-transformation-2026-08-30.
 */
