 ...
 * Used by the /demo page (with a business picker) and embedded in
 * use-case pages (with a fixed business + tailored suggestions).
 */
  ...
  const sendText = async (text: string) => {
    ...
    try {
      const res = await fetch("/api/demo", {
        ...
        body: JSON.stringify({ business, messages: next }),
      });
